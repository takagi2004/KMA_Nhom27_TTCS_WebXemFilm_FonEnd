...
const Carousel: React.FC = () => {
  ...
  return (
    <div
      ...
      data-bs-interval="3000"   // Tự chuyển sau 3s
      data-bs-pause="false"     // Không dừng khi hover
      data-bs-wrap="true"       // Quay vòng liên tục
    >
          ...
          return (
            <div key={phim.idPhim} className={`carousel-item ${index === 0 ? "active" : ""}`}>
              ...
              <div className="carousel-mobile-info d-sm-none">
                ...
                <span className="rating d-block mt-1">★ {phim.diemTrungBinh?.toFixed(1) || 0}</span>
                <div className="meta">
                  {phim.namPhatHanh} | {phim.soLuong || 0} tập | {thoiLuong}
                </div>
