      ...
      <div className="row">
        ...
        <div className="col-lg-8 mb-5">
          ...
          <div className="mb-4">
            ...
            <div
              className="bg-dark p-3 rounded border border-secondary"
              style={{
                whiteSpace: "pre-line",
                overflow: "hidden",
                maxHeight: moTaDayDu ? "300px" : "4.8em", // 3 dòng (1.6em mỗi dòng)
                display: "-webkit-box",
                WebkitLineClamp: moTaDayDu ? "unset" : 3,
                WebkitBoxOrient: "vertical",
                overflowY: moTaDayDu ? "auto" : "hidden",
              }}
            >
              {phim.moTa}
            </div>
            ...
            <div className="mt-2">
              <strong>Năm:</strong> {phim.namPhatHanh} | <strong>Quốc gia:</strong> {phim.quocGia}
            </div>
