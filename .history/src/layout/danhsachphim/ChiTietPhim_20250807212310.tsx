...
const ChiTietPhim: React.FC = () => {
  ...
  const renderTapPhim = (
    <div className="mb-4">
      ...
      <div className="d-flex overflow-auto gap-2 pb-1" style={{ whiteSpace: "nowrap" }}>
    ...
    <div className="container text-light mt-5 pt-4">
      <div className="row">
        ...
        <div className="col-lg-8 mb-5">
          ...
          <div className="d-block d-lg-none">{renderTapPhim}</div>
          {renderGioiThieu}
