...
import "./ChiTietPhim.css"; // import CSS mới
...
const ChiTietPhim: React.FC = () => {
  ...
  return (
    <div className="container text-light mt-5 pt-4 font-base">
      <div className="row">
        ...
        <div className="col-lg-8">
          <div className="main-content d-flex flex-column flex-lg-column-reverse">
            {/* Danh sách tập - Mobile ưu tiên hiển thị đầu */}
            {Array.isArray(phim.tapPhim) && phim.tapPhim.length > 0 && (
              <div className="mb-4 order-lg-1 order-1">
            ...
            {/* Video player */}
            <div className="order-lg-0 order-2 mb-4">
              {tapHienTai ? (
                <video
            ...
            {/* Giới thiệu */}
            <div className="mb-5 order-lg-2 order-3">
            ...
            {/* Đề xuất */}
            <div className="mb-5 order-4">
              <DeXuatFilm currentPhimId={phim.idPhim} title="Đề xuất cho bạn" />
            </div>
