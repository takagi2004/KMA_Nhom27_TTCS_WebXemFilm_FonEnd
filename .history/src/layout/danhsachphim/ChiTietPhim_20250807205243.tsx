...
const ChiTietPhim: React.FC = () => {
  ...
  if (!phim) {
    return <div className="text-light text-center mt-5">Đang tải...</div>;
  }
  ...
  return (
    <div className="container text-light mt-5 pt-4">
      <h2 className="text-warning mb-4">{phim.tenPhim}</h2>
      ...
      {phim.tapPhim?.length > 0 && (
        <div className="mb-5">
          <h5 className="mb-2 text-warning">Danh sách tập</h5>
      ...
      {/* Responsive layout */}
      <div className="row">
        {/* LEFT: Thông tin & bình luận */}
        <div className="col-lg-8">
          {/* Giới thiệu */}
          <div className="mb-5">
            <h5 className="mb-3">Giới thiệu</h5>
            <div
              className="bg-dark p-3 rounded border border-secondary position-relative"
              style={{
            ...
            <div className="mt-3 d-flex flex-wrap gap-3 small text-light">
