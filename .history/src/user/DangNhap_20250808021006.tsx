...
const DangNhap: React.FC = () => {
  ...
  const [hienMatKhau, setHienMatKhau] = useState<boolean>(false); // 👈 Ẩn/hiện mật khẩu
  const [dongYDieuKhoan, setDongYDieuKhoan] = useState<boolean>(false); // 👈 Checkbox điều khoản
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="form-check mb-3">
                  <input
                    ...
                    id="dongYDieuKhoan"
                  />
                  <label className="form-check-label" htmlFor="dongYDieuKhoan">
                    Tôi đồng ý với{" "}
